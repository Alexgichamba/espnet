...
class QuadMsSkaTdnnEncoder(AbsEncoder):
    """SKA-TDNN encoder with four multi-scale SKA blocks.

    This is a modified implementation of the speaker encoder described in the paper:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layer1 = block(ndim, ndim, kernel_size=3, dilation=1, scale=model_scale)
        self.layer2 = block(ndim, ndim, kernel_size=3, dilation=2, scale=model_scale)
        self.layer3 = block(ndim, ndim, kernel_size=3, dilation=3, scale=model_scale)
        self.layer4 = block(ndim, ndim, kernel_size=3, dilation=4, scale=model_scale)
        self.layer5 = nn.Conv1d(4 * ndim, output_size, kernel_size=1)
