...
def extract_embed(args):
    ...
    # 2. define train args
    spk_model, spk_train_args = SASVTask.build_model_from_file(
    ...
    iterator = SASVTask.build_iter_factory(
        args=args,
    ...
    trainer_options = SASVTask.trainer.build_options(args)
    reporter = Reporter()

    # 5. Run inference for EER and minDCF calculation
    with reporter.observe("valid") as sub_reporter:
        SASVTask.trainer.extract_embed(
            model=spk_model,
            iterator=loader,
