...
from espnet2.iterators.contrastive_iter_factory import ContrastiveIterFactory
...
from espnet2.samplers.category_contrast_sampler import CategoryContrastiveSampler
...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument(
            "--iterator_type",
            type=str,
            choices=["sequence", "category", "contrastive" , "chunk", "task", "none"],
            default="sequence",
    ...
    def build_iter_factory(
        ...
        elif iterator_type == "contrastive":
            return cls.build_contrastive_iter_factory(
                args=args,
                iter_options=iter_options,
                mode=mode,
            )
    ...
    @classmethod
    @typechecked
    def build_contrastive_iter_factory(
        cls, args: argparse.Namespace, iter_options: IteratorOptions, mode: str
    ) -> AbsIterFactory:
        ...
        batch_sampler = CategoryContrastiveSampler(**sampler_args)
